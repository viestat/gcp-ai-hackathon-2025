...
from ai_tutor.agent import root_agent
from ai_tutor.utils.deployment import (
    parse_env_vars,
    print_deployment_success,
    write_deployment_metadata,
)
from ai_tutor.utils.gcs import create_bucket_if_not_exists
from ai_tutor.utils.tracing import CloudTraceLoggingSpanExporter
from ai_tutor.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    config = AgentEngineConfig(
        ...
        description="AI Tutor - Personalized Learning Agent with Multimodal Capabilities",
    ...
    logging.debug("Agent config prepared")
